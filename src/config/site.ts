...
export const site: SiteConfig = {
  ...
  shortName: 'Ride A Pet',
  description: 'Complete Ride A Pet wiki with codes, pet tier lists, egg locations, mutation guides and rebirth tips. Every page carries a last-verified date.',
  domain: 'rideapet.net',
  tagline: 'Everything for Ride A Pet — codes, pets, eggs and mutations',
  legalNotice: 'Ride A Pet Wiki is a fan-made community site. Not affiliated with or endorsed by the game developer.',
